    ...
    return (
        <section className='about-me'>
            ...
            <article className='about-me__article'>
                <img className='article__image' src={myPortfolioImage} alt="мое фото" />
                <h2 className='article__title'>Павел</h2>
                <h3 className='article__description'>Веб-разработчик, 43 года</h3>
                <p className='article__text'>Родился в Белоруссии. По профессии - артист балета. Много путешествовал по миру. Общался с людьми из разных стран.
